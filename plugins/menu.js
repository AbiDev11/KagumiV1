...
*BOT INFO*
» *Bot Name:* 𝙺𝙰𝙶𝚄𝙼𝙸 𝙼𝚄𝙻𝚃𝙸𝙳𝙴𝚅𝙸𝙲𝙴
» *Lib*: Baileys-MultiAuth
...
// Fake Contact
 const fcon = {
    ...
    let thumb = 'https://telegra.ph/file/a09fb591fc59475704576.jpg'
    let menu = [
    '🧢'
    ]
    ...
    conn.sendButton(m.chat, text.trim(),"2023 © 𝙺𝙰𝙶𝚄𝙼𝙸 𝙼𝚄𝙻𝚃𝙸𝙳𝙴𝚅𝙸𝙲𝙴", await (await fetch(thumb)).buffer(), [['𝙾𝚆𝙽𝙴𝚁', '.owner'],['𝙳𝙾𝙽𝙰𝚂𝙸', '.donasi'],['𝚂𝙿𝙴𝙴𝙳', '.store']], true, { quoted: m })
